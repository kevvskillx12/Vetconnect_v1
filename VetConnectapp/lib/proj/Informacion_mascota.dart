...
class _InformacionMascotaState extends State<InformacionMascota> {
  ...
  Future<void> _loadMascotas() async {
    try {
      ...
      print("Macscotas obtenidas: $mascotasData");
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: const Color(0xFFF5EEC8), // Cambio de color de fondo
      appBar: AppBar(
        title: const Center(
          child: Text(
            'Información de la Mascota',
            style: TextStyle(
              color: Colors.white, // Cambio de color de letras a blanco
            ),
          ),
        ),
        backgroundColor: const Color(0xFFA67B5B), // Cambio de color del AppBar
        iconTheme: const IconThemeData(
            color: Colors.white), // Cambio de color del botón de retroceso
      ),
      body: isLoading
